...
\usepackage{../templates/scriv2tex}			% Some few specific arrow symbols used throughout the document, based on extpfeil
...
%\usepackage{showkeys}				% For TESTING only: referentiewoorden van de labels verschijnen in het pdf-document i.p.v. de nummers. 
...
\renewcommand{\caption}[1]{\textit{#1}}

								% Sourced from http://tug.ctan.org/tex-archive/info/epslatex/english/epslatex.pdf page 55
...
%% Cross-referencing				% Allow the format of cross-references to be determined automatically according to the “type” of cross-reference (equation, section, etc.)
...
\usepackage{graphicx}
%\graphicspath{{src/images}} %Setting the graphicspath; only necessary for manual TexWorks processing
\usepackage{multirow}
\usepackage{booktabs}

%% Theorems 
\usepackage[ntheorem]{empheq}	
\usepackage[amsmath,thmmarks]{ntheorem}		% Use new theorems package as opposed to amsth, and include <amsmath>-emulation by including it as an option; without it, the equation references do not work anymore.
...
%%
%% Defining new theorem and -styles. Its documentation can be found at ftp://ftp.dante.de/pub/tex/macros/latex/contrib/ntheorem/ntheorem.pdf
